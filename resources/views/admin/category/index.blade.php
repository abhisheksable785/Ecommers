                ...
                <div class="offcanvas-body">
                    <form action="{{ route('category.store') }}" method="POST" enctype="multipart/form-data" id="addCategoryForm">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control" name="image" id="add_image" accept="image/*" required>
                            <img id="add_image_preview" 
                                 src="" 
                                 width="100" 
                                 class="d-none mt-2 rounded border"
                                 alt="Preview">
                        </div>
                        ...
                        <button type="button" class="btn btn-secondary w-100 mt-2" data-bs-dismiss="offcanvas">Cancel</button>
                    </form>
                </div>
            </div>
    ...
    $(document).on('click', '.editCategoryBtn', function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('#editCategoryForm').attr('action', "{{ url('category/update') }}/" + response.id);
