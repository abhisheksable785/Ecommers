...
{{-- Push page-specific styles to the master layout's head or styles section --}}
            ...
            <div class="card">
              <div class="card-datatable table-responsive">
                <table class="datatables-customers table border-top">
                  ...
                  <tbody>
                    {{-- Blade loop to display customers --}}
                    @forelse ($allCustomers as $customer)
                    <tr>
                      {{-- These are placeholder columns. Adjust to your actual data. --}}
                      <td></td> 
                      <td></td> 
                      <td>{{ $customer->name  }}</td>
                      <td class="text-nowrap">{{ $customer->id ?? 'N/A' }}</td>
                      <td>{{ $customer->country ?? 'N/A' }}</td>
                      <td>{{ $customer->orders_count ?? 0 }}</td>
                      <td class="text-nowrap">${{ number_format($customer->total_spent ?? 0, 2) }}</td>
                    </tr>
                    @empty
                    <tr>
