                                        ...
                                        <td class="product__cart__item">
                                            <div class="product__cart__item__pic">
                                                <img src="{{ asset('storage/' . $item->product->image) }}"
                                                    alt="{{ $item->product->name }}" style="width: 80px; height: 80px;">
                                        ...
                                        <td class="quantity__item">
                                            <div class="quantity">
                                                <div class="pro-qty" data-id="{{ $item->id }}">
                                                    <button class="qtybtn dec"
                                                        {{ $item->quantity <= 1 ? 'disabled' : '' }}>-</button>
                                                    <input type="text" class="qty-input"
                                                        value="{{ max(1, $item->quantity) }}" readonly
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        if (res.success) {
                            ...
                            // Update row total
                            var price = parseFloat(parent.closest('tr').find(
                                '.product__cart__item__text h5').text().replace(/[₹,]/g,
                                '')) || 0;
                            ...
                            $('.cart__total span, .cart__total li span').text('₹' + subtotal
                                .toFixed(2));
